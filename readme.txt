=== Plugin Name ===
Contributors: meinsw
Donate link: http://www.meinstoffwechsel.com/
Tags: image credits, credits, image, media
...
Thanks to <a href="https://www.meinstoffwechsel.com">meinstoffwechsel</a> for the financial contribution regarding development of this plugin.

== Installation ==

1. Install Plugin
2. Add your own image credit notes to the new box in your page/post-edit sites in backend.
3. Insert shortcode [image_credits] wherever you like to show image credits.
...
1. In backend, our plugin will automatically add a box below the text editor on all page- or post-edit pages. There you'll be able to insert any image credit information.
2. The shortcode [image_credits] will output all image credits in one consolidated list - ideal for a separate page or for your imprint page.
3. The way [image_credits] looks for users.
